...
const mock = {};
mock[`POST ${VITE_APP_APIHOST || ''}/product/getProduct`] = (req, res) => {
    res.send({
        code: 0,
        data: {
            productList: [
...
mock[`POST ${VITE_APP_APIHOST || ''}/product/getCategory`] = (req, res) => {
    res.send({
        code: 0,
        data: {
            categoryList:
...
mock[`POST ${VITE_APP_APIHOST || ''}/product/getProdetail`] = (req, res) => {
    res.send({
        code: 0,
        data: {
            productList: [
...
mock[`POST ${VITE_APP_APIHOST || ''}/product/getShopCart`] = (req, res) => {
    res.send({
        code: 0,
        data: {
            shopCartList: [
                {
                    ...
                    channelType: null,
                    channelValidEndTime: "",
                    channelValidStartTime: "",
                    coverImage: "https://res.qiumeiapp.com/xcx/proImagesAmECTEcNz3.jpg",
                    currentPrice: "268.00",
                    depositPrice: null,
                    isLimitedPurchase: 0,
                    isNoncoupon: 0,
                    ...
                    limitedPurchaseMinBuyCount: 0,
                    limitedPurchaseMinBuyType: 0,
                    originalPrice: 268,
                    productCount: 1,
                    productId: 40004,
                    productName: "薇诺娜舒敏保湿特护霜50g",
                    rebateAmount: 26.8,
                    shoppingCartProductId: 8318605,
                    soldCount: 3879,
                    subName: ""
                },
                {
                    ...
                    channelValidEndTime: "",
                    channelValidStartTime: "",
                    coverImage: "https://yimei-res.qiumeiapp.com/ymNew/ymProduct/jZsG83bTGdpJD3eynM1iFNs3D4ks33Qx.jpg",
                    currentPrice: "88.00",
                    depositPrice: null,
                    isLimitedPurchase: 0,
                    isNoncoupon: 0,
